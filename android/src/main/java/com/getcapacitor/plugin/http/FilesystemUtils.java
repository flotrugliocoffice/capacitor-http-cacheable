...
public class FilesystemUtils {
    ...
    public static Object getObjectFromFile(Context context, File source) {
        //Primo test tenta lettura via stringa...
        try {
            ...
            JSObject jobject = new JSObject(total.toString());
            return jobject;
        } catch (Exception ex) {
    ...
    public static boolean storeCacheFile(Context context, String filename, Object content) {
        ...
        try {
            ...
            if (content instanceof JSObject) {
                ...
                OutputStreamWriter sos = new OutputStreamWriter(fos);
                sos.write(content.toString());
                sos.close();
                fos.close();
            } else {
                FileOutputStream fos = new FileOutputStream(outputFile);
